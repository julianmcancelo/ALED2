...
public class MainFrame extends JFrame {
    ...
    public MainFrame(String nombreCompleto, String usuario, ServicioLogin.RolUsuario rolUsuario) {
    ...
    private void gMateriasActionPerformed(ActionEvent evt) {
        // Lógica para abrir gestión de materias
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            MainFrame mainFrame = new MainFrame(nombreCompleto, usuario, rolUsuario);
