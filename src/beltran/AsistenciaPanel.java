...
public class AsistenciaPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"ID", "Nombre", "Apellido", "DNI", "Legajo", "Año", "Presente"}, 0);
    ...
    private void cargarAlumnos() throws SQLException {
        ...
        if (carrera != null && ano != null && comision != null && turno != null) {
            String[] alumnos = materiaService.obtenerAlumnos(carrera, ano, comision, turno);
    ...
    private void updateAlumnosTable(String[] alumnos) {
        ...
        for (String alumno : alumnos) {
            ...
            if (datos.length == 7) {
                ...
                // Debugging output to check the format of the data
                System.err.println("Datos del alumno mal formateados: " + alumno);
            }
        }
    }
    ...
    private void confirmarRegistroAsistencia() {
        ...
        try {
            ...
            for (int i = 0; i < tableModel.getRowCount(); i++) {
                ...
                materiaService.registrarAsistencia(alumnoId, (String) cmbCarrera.getSelectedItem(), (String) cmbMateria.getSelectedItem(), (Integer) cmbAno.getSelectedItem(), turno, fecha, comision, presente);
            }
    ...
    public static void main(String[] args) {
        // Aquí debes configurar tu servicio de materia
        ...
        // Agrega el panel de asistencia
        AsistenciaPanel panel = new AsistenciaPanel(materiaService);
        frame.add(panel);
